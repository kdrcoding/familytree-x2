      ...
      <div className="mt-1.5 flex flex-wrap gap-1.5">
        {people.map((p) => (
          <button
            ...
            className="rounded-full border border-stone-300 bg-stone-50 px-3.5 py-2 text-sm font-medium text-stone-700 transition-colors hover:border-brand-400 hover:bg-brand-50 hover:text-brand-800 focus-visible:ring-2 focus-visible:ring-brand-500 dark:border-stone-600 dark:bg-stone-800 dark:text-stone-200 dark:hover:bg-brand-950/60"
          >
            {fullName(p)}
          ...
          return (
            <span key={spouse.id} className="inline-flex items-center gap-1">
              <button
                ...
                className={`rounded-full border px-3.5 py-2 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-brand-500 ${
                  divorced
                    ? 'border-stone-300 bg-stone-100 text-stone-500 dark:border-stone-600 dark:bg-stone-800/60 dark:text-stone-400'
                    : 'border-stone-300 bg-stone-50 text-stone-700 hover:border-brand-400 hover:bg-brand-50 hover:text-brand-800 dark:border-stone-600 dark:bg-stone-800 dark:text-stone-200 dark:hover:bg-brand-950/60'
                }`}
              >
                {fullName(spouse)}
              ...
              {editMode && (
                <button
                  ...
                  className={`inline-flex h-9 w-9 items-center justify-center rounded-full border transition-colors focus-visible:ring-2 focus-visible:ring-brand-500 ${
                    divorced
