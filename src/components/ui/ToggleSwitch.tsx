  ...
  return (
    ...
    >
      ...
      <span className="relative inline-flex shrink-0">
        ...
        <span
          aria-hidden
          className="h-6 w-11 rounded-full bg-stone-300 transition-colors peer-checked:bg-brand-600 peer-focus-visible:ring-2 peer-focus-visible:ring-brand-500 peer-focus-visible:ring-offset-2 dark:bg-stone-600 dark:peer-focus-visible:ring-offset-stone-900"
        />
        <span
          aria-hidden
