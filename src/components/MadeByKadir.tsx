        ...
        >
          <div className="flex items-start justify-between gap-2">
            ...
            <button
              ...
              className="rounded-lg p-1 text-stone-400 transition-colors hover:bg-stone-100 hover:text-stone-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 dark:hover:bg-stone-800 dark:hover:text-stone-200"
            >
            ...
            {CONTACTS.map(({ key, href, label, handle, icon: Icon, iconClass }) => (
              <li key={key}>
                <a
                  ...
                  className="flex items-center gap-3 rounded-xl px-2.5 py-2 transition-colors hover:bg-stone-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 dark:hover:bg-stone-800"
                >
                  <span
