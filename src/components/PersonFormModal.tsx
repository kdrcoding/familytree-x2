    ...
    <Modal onClose={handleClose} labelledBy="person-form-title" size="lg">
      <form onSubmit={submit} noValidate>
        ...
        {askOtherParent && linkTarget && (
          <div className="mt-4 rounded-xl bg-brand-50 p-3 dark:bg-brand-950/50">
            ...
            <p className="mt-1 text-xs text-brand-900/80 dark:text-brand-200/80">
        ...
        {!isEdit && linkTarget && (
          <p className="mt-4 rounded-xl bg-brand-50 p-3 text-sm text-brand-900 dark:bg-brand-950/50 dark:text-brand-200">
            {t('form.willBeAdded', {
