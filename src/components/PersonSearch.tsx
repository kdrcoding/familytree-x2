          ...
          {results.map((person) => (
            <li key={person.id}>
              <button
                type="button"
                role="option"
                className="flex w-full items-center gap-3 px-3 py-3 text-left hover:bg-brand-50 focus-visible:bg-brand-50 dark:hover:bg-brand-950/40 dark:focus-visible:bg-brand-950/40"
