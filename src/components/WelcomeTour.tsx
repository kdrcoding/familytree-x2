    ...
    >
      <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl dark:bg-stone-900">
        <div className="flex items-start justify-between gap-3">
          <span className="rounded-2xl bg-brand-100 p-3 text-brand-700 dark:bg-brand-900/50 dark:text-brand-300">
        ...
        <p className="mt-4 text-sm font-semibold uppercase tracking-wide text-brand-700 dark:text-brand-400">
