...
export const en = {
  ...
  'home.title': 'Shajira Family Tree',
  'home.intro':
  ...
  'home.bdayEmpty':
    'No birthdays or anniversaries coming up in the next {days} days. Add birth or wedding dates on people’s profiles to see them here.',
  ...
  'tree.share': 'Share',
  'tree.shareTitle': 'Share or save the tree image',
  ...
  'form.gender': 'Gender',
  'form.moreDetails': 'More details (optional) — place, photo, occupation, biography',
  'form.nickname': 'Nickname',
  'form.nicknameHint': 'Shown on the tree when the full name is long (e.g. KDR)',
...
export const uz: Record<TKey, string> = {
  ...
  'home.title': 'Shajira — oilaviy shajara',
  'home.intro':
  ...
  'home.bdayEmpty':
    'Keyingi {days} kun ichida tug‘ilgan kun yoki yubiley yo‘q. Bu yerda ko‘rinishi uchun tug‘ilgan yoki nikoh sanasini qo‘shing.',
  ...
  'tree.share': 'Ulashish',
  'tree.shareTitle': 'Shajara rasmini ulashish yoki saqlash',
  ...
  'form.gender': 'Jinsi',
  'form.moreDetails':
    "Qo'shimcha ma'lumotlar (ixtiyoriy) — joy, rasm, kasb, tarjimai hol",
  'form.nickname': 'Laqabi',
  'form.nicknameHint': "To'liq ism uzun bo'lsa daraxt kartasida ko'rinadi (masalan, KDR)",
