        ...
        <div className="relative mx-auto max-w-3xl px-5 pb-14 pt-10 sm:px-8 sm:pb-18 sm:pt-14">
          ...
          <div className="home-hero__actions mt-6 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <button
              ...
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-brand-300 bg-white/70 px-6 py-3 text-base font-semibold text-brand-900 shadow-sm backdrop-blur-sm transition-all hover:bg-white hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-brand-100 dark:border-white/25 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 dark:focus-visible:ring-white dark:focus-visible:ring-offset-brand-950 active:translate-y-0"
            >
