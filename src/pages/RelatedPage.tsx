    ...
    <div className="mx-auto w-full max-w-2xl px-4 py-6 sm:px-6">
      <header className="mb-6">
        ...
        <h1 className="mt-1 flex items-center gap-2 text-3xl font-extrabold tracking-tight text-stone-900 dark:text-stone-50">
          <GitBranch className="h-8 w-8 text-brand-600" aria-hidden />
          {t('related.title')}
        </h1>
      ...
      {result && (
        <section
          className="card mt-6 overflow-hidden border-t-4 border-t-brand-500 p-6 text-center shadow-[0_1px_3px_0_rgb(0_0_0_0.06)] dark:shadow-[0_1px_3px_0_rgb(0_0_0_0.3)]"
          aria-live="polite"
        >
...
function SelectedPerson({
  ...
  return (
    <div className="flex items-center gap-3 rounded-2xl bg-brand-50 p-3 dark:bg-brand-950/40">
