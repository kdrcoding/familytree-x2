      ...
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div>
          <h2 className="flex items-center gap-2 font-semibold">
            <ScrollText className="h-5 w-5 text-brand-600" aria-hidden /> {t('settings.logTitle')}
          </h2>
                  ...
                  <span
                    className={`badge ${
                      entry.actor === AUTH_EMAILS.owner
                        ? 'border-brand-300 bg-brand-50 text-brand-800 dark:border-brand-800 dark:bg-brand-950/60 dark:text-brand-300'
                ...
                <div className="mt-1 space-y-0.5 text-stone-600 dark:text-stone-300">
                  {details.added && details.added.length > 0 && (
                    <p className="flex items-start gap-1.5">
                      <UserPlus className="mt-0.5 h-3.5 w-3.5 shrink-0 text-brand-600" aria-hidden />
...
function BackupsCard() {
  ...
  return (
    <section className="card mt-4 p-6">
      <h2 className="flex items-center gap-2 font-semibold">
        <Archive className="h-5 w-5 text-brand-600" aria-hidden /> {t('settings.backupsTitle')}
      </h2>
...
function CountriesCard() {
  ...
  return (
    <section className="card mt-4 p-6">
      <h2 className="flex items-center gap-2 font-semibold">
        <Globe className="h-5 w-5 text-brand-600" aria-hidden /> {t('settings.countriesTitle')}
      </h2>
      <p className="mt-1 text-sm text-stone-500 dark:text-stone-400">
...
function PhotosCard() {
  ...
  return (
    <section className="card mt-4 p-6">
      <h2 className="flex items-center gap-2 font-semibold">
        <Images className="h-5 w-5 text-brand-600" aria-hidden /> {t('settings.photosTitle')}
      </h2>
...
export function SettingsPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
      ...
      <section className="card mt-6 border-brand-300 p-6 shadow-[0_1px_3px_0_rgb(0_0_0_0.04)] dark:border-brand-800 dark:shadow-[0_1px_3px_0_rgb(0_0_0_0.2)]">
        <h2 className="flex items-center gap-2 font-semibold">
          <Eye className="h-5 w-5 text-brand-600" aria-hidden /> {t('settings.easyTitle')}
        </h2>
      ...
      <section className="card mt-4 p-6 shadow-[0_1px_3px_0_rgb(0_0_0_0.04)] dark:shadow-[0_1px_3px_0_rgb(0_0_0_0.2)]">
        <h2 className="flex items-center gap-2 font-semibold">
          <Languages className="h-5 w-5 text-brand-600" aria-hidden /> {t('settings.language')}
        </h2>
      ...
      <section className="card mt-4 p-6">
        <h2 className="flex items-center gap-2 font-semibold">
          <Link2 className="h-5 w-5 text-brand-600" aria-hidden /> {t('invite.title')}
        </h2>
      ...
      <section className="card mt-4 p-6">
        <h2 className="flex items-center gap-2 font-semibold">
          <Sun className="h-5 w-5 text-brand-600" aria-hidden /> {t('settings.theme')}
        </h2>
      ...
      <section className="card mt-4 p-6">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          <span className="badge border-brand-300 bg-brand-50 text-brand-800 dark:border-brand-800 dark:bg-brand-950/60 dark:text-brand-300">
