...
export async function buildBirthdayCardPng(opts: {
  ...
  const photoBlock = photoHref
    ? `
      ...
      <circle cx="450" cy="200" r="78" fill="#d4af37" />
      <image href="${photoHref}" x="378" y="128" width="144" height="144" clip-path="url(#avatar)" preserveAspectRatio="xMidYMid slice" />
    `
    : `<circle cx="450" cy="190" r="56" fill="#1e5a96" />`;

  const svg = `<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" width="900" height="600" viewBox="0 0 900 600">
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="#0f3a6e"/>
      <stop offset="100%" stop-color="#1a4f7a"/>
    </linearGradient>
  </defs>
  <rect width="900" height="600" fill="url(#bg)"/>
  <rect x="48" y="48" width="804" height="504" rx="36" fill="#faf8f3"/>
  <rect x="48" y="48" width="804" height="14" rx="4" fill="#d4af37"/>
  ${photoBlock}
  <text x="450" y="${photoHref ? 330 : 300}" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" font-size="52" fill="#1e3a5f">Happy Birthday</text>
  ...
  <text x="450" y="${photoHref ? 455 : 425}" text-anchor="middle" font-family="system-ui, sans-serif" font-size="28" fill="#785a1e">${ageLine}</text>
  <text x="450" y="520" text-anchor="middle" font-family="system-ui, sans-serif" font-size="22" fill="#64748b">Shajira · Family</text>
</svg>`;
