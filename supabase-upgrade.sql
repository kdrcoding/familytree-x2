...
--        email: owner@ravshanov.family    password: (choose a strong owner password)
--        email: family@ravshanov.family   password: (choose a family editor password)
...
as $$
  select coalesce(auth.jwt() ->> 'email', '')
         in ('owner@ravshanov.family', 'family@ravshanov.family');
$$;
...
stable
as $$
  select coalesce(auth.jwt() ->> 'email', '') = 'owner@ravshanov.family';
$$;
